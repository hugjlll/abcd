...
from IDidentify.mdui import Ui_Dialog
import PyQt5
from IDidentify.identifyFrame import IdentifyDialog
...
class MainDialog(QtWidgets.QMainWindow):
    ...
    def goin(self):
        # self.monitorframe = (PyQt5.QtWidgets.QDialog())
        self.monitorframe = IdentifyDialog()
